          ...
          <div className="bg-off-black rounded-3xl p-12 md:p-16 text-center relative overflow-hidden">
            ...
            >
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                className="inline-flex items-center gap-3 px-10 py-5 bg-membook-green text-off-black font-semibold text-lg rounded-full hover:shadow-2xl hover:shadow-membook-green/50 transition-all duration-300"
              >
